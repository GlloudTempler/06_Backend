 ...
 * date : 2023-10-04
 * description :
 * 요약 :     uel에 대항하는 jsp파일로 연결하기
 *           @명칭 : 자바의 어노테이션, 주로 함수/클래스/변수 위에 붙여서 사용
 *           작은 기능이 함수에 추가됨
 *           목적 : 사용하면 코딩량이 획기적으로 줄음
...
//        TODO : 연습 url : "/exam/00/hello2"
//               => jsp : "/exam00/example01.jsp" : 화면에 Hello & Spring boot 출력
    }
}
