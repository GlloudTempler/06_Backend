...
//  TODO : url 테스트 : http://localhost:8000/exam05/path-variable/KanTaeGyung
//         => 파라메터 방식 : @GetMapping("/path-variable/{웹매개변수명}")
//         => 웹브라우저 주소창 사용 : url / 값
//    TODO : 쿼리 스트링 : http://localhost:8000/exam05/path-variable?name=KangTaeGyung
...
//    TODO : 연습 1) 아래와 같이 url이 정의되어 있다. 컨트롤러 함수를 작성
