...
<body>
    <div class="container">
        ...
        <%--              사용법 : <p> <c:set var="변수명" value="값" (scope="page") /> </p> --%>
...
<%--        <c:redirect url="/exam01/hello" />--%>
        ...
        <%--        chars 문자열에 name값 있으면 true, 없으면 false --%>
        ...
        <%-- TODO : 6) chars에서 0인덱스 ~ 6-1 인덱스 자르기 --%>
